"""Variante de mini-replicaset.py qui écrit un statut (exercice 4 du chapitre 36).
...
def requete(methode, chemin, corps=None, type_contenu="application/json"):
...
def ecrire_statut(cm, pods, voulu):
    ...
    print(f"{time.strftime('%H:%M:%S')} {cm['metadata']['name']} : statut {statut}", flush=True)
